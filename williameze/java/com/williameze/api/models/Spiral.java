...
public class Spiral extends ModelObject
{
    public List<Vector> midPoints = new ArrayList();
    public List<Cylinder> segments = new ArrayList();

    public static Spiral create(Vector startPoint, Vector centerPivot, Vector axis, double initialRot, double rotAngle, int segmentCount,
	    double incrementAlongAxis, double cylRadius, int cylCuts)
    {
	...
	return new Spiral(cylRadius, cylCuts, l);
    }
     ...
     * @param cylCuts
     * @param list
     *            list of midpoints of cylinder's inbetween faces, with the
     ...
     */
    public Spiral(double cylRadius, int cylCuts, List<Vector> list)
    {
	...
	for (int a = 1; a < list.size()-2; a++)
	{
	    ...
	    Vector nor1 = (center2.subtract(center1).crossProduct(pre1.subtract(center1))).crossProduct(pre1.subtract(center1).add(center2.subtract(center1)));
	    Vector nor2 = (post2.subtract(center2).add(center1).subtract(center2)).crossProduct(post2.subtract(center2).crossProduct(center1.subtract(center2)));
