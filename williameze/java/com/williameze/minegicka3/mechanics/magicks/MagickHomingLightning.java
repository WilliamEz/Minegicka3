...
public class MagickHomingLightning extends Magick
{
    ...
    public List<String> getDescription()
    {
        return Arrays.asList(new String[]{
        	"Sends out auto-targeting projectiles that will strike lightning on contact with target.",
        	"Radius of auto-targeting: 8 x staff's power (blocks)",
        	"Amount of projectiles: 6 + 2 x staff's attack speed"
        });
    }
